from lab2.functions.calcFunctions import AddOperation, SubtractOperation, MultiplyOperation, DivideOperation, PowerOperation, SqrtOperation, ModulusOperation
from lab2.init import memory, app_settings
import lab2.constants.constants as const
...
class Calculator:
    ...
    def log_to_file(self, expression, result):
        try:
            with open("lab2/logs/calculator_history.txt", "a") as logFile:
